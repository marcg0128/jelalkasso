        ...
        <>
            ...
            <div className="flex min-h-screen flex-col justify-between pl-30 mt-50">
                <section id="start" className="relative">
                    {/* Animierter Hauptname */}
                    <h1
                            className={`text-[10rem] font-bold sticky top-0 z-51`}
                            style={{
                    ...
                    {/* Social Media Icons - verschwinden beim Scrollen */}
                    <div
                    ...
                    {/* Zusätzlicher Content für Scroll-Demonstration */}
            ...
            <div
                className="fixed bottom-8 right-8 w-2 h-20 bg-gray-200 rounded-full overflow-hidden z-40"
            >
                <div
                    className="bg-blue-600 w-full transition-all duration-100 ease-out rounded-full"
                    style={{
